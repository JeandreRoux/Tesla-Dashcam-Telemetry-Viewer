...
FONT_SPEED = ImageFont.truetype("fonts/arial.ttf", 32)
FONT_SPEED_UNIT = ImageFont.truetype("fonts/arialbd.ttf", 14)
FONT_AUTOPILOT = ImageFont.truetype("fonts/arialbd.ttf", 14)
FONT_GEAR = ImageFont.truetype("fonts/arialbd.ttf", 16)
